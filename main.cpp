...
#include <src/Includes/Vector3.h>
...
Java_uk_lgl_modmenu_FloatingModMenuService_Title(
        JNIEnv *env,
        jobject activityObject) {
    jstring str = env->NewStringUTF("Your Name");
    return str;
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(
	...
	// SeekBar_[feature name]_1_3
	
    const char *features[] = {
            "Text_Your Text",
            "Button_Telekill",
            "Button_Masskill",
            "ButtonHide_Icon invisible"};
...
bool feature1 = false, feature2 = false;
bool telekill = false;
bool masskill = false;
...
Java_uk_lgl_modmenu_FloatingModMenuService_Changes(
    ...
    LOGD("Feature: %d | Value: = %d", feature, value);
...
void Player_update(void* player) {
    bool isMine = *(bool *) ((uint64_t) player + 0x2C);
...
void *hack_thread(void *) {
    ...
    */
    ...
    MSHookFunction((void *) getAbsoluteAddress(libName, 0xBC9C20), (void *) Player_update,
                   (void **) &old_Player_update); //Standoff.Player(Player Update)
#endif
